...
def process(origins):
    ...
    destinations = ['BRODY SQUARE', 'LANDON HALL MSU', 'HOLDEN DINING HALL', 'HOLMES DINING HALL MSU', 'SOUTH POINTE AT CASE', 'THE EDGE AT AKERS', 'THE GALLERY AT SYNDER PHILLIPS', 'THE VISTA AT SHAW', 'THRIVE AT OWEN', 'MSU INTERNATIONAL CENTER', 'MSU UNION', 'HUBBARD HALL MSU', 'WONDERS HALL MSU', 'HANNAH ADMIN BUILDING MSU', 'MCDONEL HALL MSU', '1855 PLACE MSU', 'KELLOGG CENTER MSU', 'MINSKOFF PAVILION', 'WELLS HALL', 'MSU BAKERS']
